...
import com.qf.tmall.dao.ProductMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<Product> getList(Product product, Byte[] product_isEnabled_array, OrderUtil orderUtil, PageUtil pageUtil,String orderStr,String productName) {
        return productMapper.select(product, product_isEnabled_array, orderUtil, pageUtil,orderStr,productName);
    }
