...
import com.qf.tmall.dao.ProductOrderMapper;
...
public class ProductOrderServiceImpl implements ProductOrderService {
    ...
    //获取分页信息
    @Override
    public PageInfo<ProductOrder> getProductOrderList(int pageNum, int pageSize) {

        PageHelper.startPage(pageNum,pageSize);
        List<ProductOrder> data = productOrderMapper.getProductOrderList();

        return new PageInfo<ProductOrder>(data);
