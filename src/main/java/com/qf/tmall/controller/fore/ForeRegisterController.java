...
public class ForeRegisterController extends BaseController {
    ...
    //转到前台天猫-用户注册页
    @ApiOperation(value = "转到前台天猫-用户注册页")
    ...
    public String getAddress() {
        ...
        object.put("cityList", cityAddress);
        object.put("districtList", districtAddress);
        object.put("addressId", addressId);
        object.put("cityAddressId", cityAddressId);
        logger.info("返回地址信息 JSON");
        return object.toJSONString();
    }

    //天猫前台-用户注册-ajax
    @ApiOperation(value = "天猫前台-用户注册")
    @ResponseBody
