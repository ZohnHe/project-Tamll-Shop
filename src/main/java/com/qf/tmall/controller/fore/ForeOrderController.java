...
/**
 * @author ACI
 * @Title: ForeOrderController
 * @ProjectName com.qf
 * @Description: TODO
 * @date 2019/2/21 21:08
 */
@Api(tags = "前台天猫-订单相关数据")
@Controller
public class ForeOrderController extends BaseController {
    ...
    //转到前台天猫-购物车页
    @ApiOperation(value = "转到前台天猫-购物车页")
    ...
    //转到前台天猫-购物车订单建立页
    @ApiOperation(value = "转到前台天猫-购物车订单建立页")
    @RequestMapping(value = "order/create/byCart", method = RequestMethod.GET)
    public String goToOrderConfirmPageByCart(HttpSession session,
        ...
        session.setAttribute("order_item_list",order_item_list);
        logger.info("转到前台天猫-订单建立页");
        return "fore/productBuyPage";
    }

    @ApiOperation(value = "转到前台天猫-购物车订单建立页-获取页面相关数据")
    @ResponseBody
    @RequestMapping(value = "order/create/byCart/getdata", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
    public String goToOrderConfirmPageByCartGetDatas( HttpServletRequest request
                                             ) throws UnsupportedEncodingException {

        Integer[] order_item_list = (Integer[]) request.getSession().getAttribute("order_item_list");
        JSONObject object = new JSONObject();
        logger.info("检查用户是否登录");
        ...
        object.put("orderTotalPrice", orderTotalPrice);

        object.put("addressId", addressId);
        object.put("cityAddressId", cityAddressId);
        object.put("districtAddressId", districtAddressId);
        object.put("order_post", order_post);
        object.put("order_receiver", order_receiver);
        object.put("order_phone", order_phone);
        object.put("detailsAddress", detailsAddress);
    ...
    //转到前台天猫-订单支付页
    @ApiOperation(value = "转到前台天猫-订单支付页")
    ...
    @ApiOperation(value = "转到前台天猫-订单支付页 - 获取相关数据")
    @ResponseBody
    @RequestMapping(value = "order/pay/getdata", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String goToOrderPayPageGetData( HttpSession session) {
        String order_code = (String) session.getAttribute("order_code");
        JSONObject object = new JSONObject();
        logger.info("------验证订单信息------");
        ...
        object.put("productOrder", order);
        object.put("orderTotalPrice", orderTotalPrice);
        return object.toJSONString();
    }

    //转到前台天猫-订单支付成功页
    @ApiOperation(value = "转到前台天猫-订单支付成功页")
    ...
    @ApiOperation(value = "转到前台天猫-订单支付成功页 - 返回相关数据")
    @ResponseBody
    @RequestMapping(value = "order/pay/success/getdata", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String goToOrderPaySuccessPageGetData(HttpSession session) {
        ...
        jsonObject.put("productOrder", order);
        jsonObject.put("orderTotalPrice", orderTotalPrice);

        logger.info("转到前台天猫-订单支付成功页 - 返回数据");
        return jsonObject.toJSONString();

    }

    //转到前台天猫-订单确认页
    @ApiOperation(value = "转到前台天猫-订单确认页")
    ...
    @ApiOperation(value = "转到前台天猫-订单确认页 - 返回相关数据")
    @ResponseBody
    @RequestMapping(value = "order/confirm/getdata", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String goToOrderConfirmPagegetdata( HttpSession session) {
    ...
    //更新订单信息为已支付，待发货-ajax
    @ApiOperation(value = "更新订单信息为已支付，待发货")
    @ResponseBody
    ...
    //转到前台天猫-订单完成页
    @ApiOperation(value = "转到前台天猫-订单完成页")
    ...
    //转到前台天猫-订单完成页
    @ApiOperation(value = "转到前台天猫-订单完成页 - 返回数据")
    @ResponseBody
    @RequestMapping(value = "order/success/getdata", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String goToOrderSuccessPageGetData( HttpSession session) {
        String order_code = (String) session.getAttribute("order_code");
        JSONObject object = new JSONObject();
        logger.info("------验证订单信息------");
        ...
        if (count == 1) {
            ...
            object.put("orderItem", productOrderItem);
        }

        object.put("product", product);

        logger.info("转到前台天猫-订单完成页 - 返回数据");
        return object.toJSONString();
    }
    ...
    //更新订单信息为交易成功-ajax
    @ApiOperation(value = "更新订单信息为交易成功")
    @ResponseBody
    ...
    //更新订单信息为交易关闭-ajax
    @ApiOperation(value = "更新订单信息为交易关闭")
    @ResponseBody
    ...
    @ApiOperation(value = "转到前台天猫-订单列表")
