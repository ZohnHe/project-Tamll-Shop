...
public class ForeUserController extends BaseController {
    ...
    //转到前台天猫-用户详情页
    @ApiOperation(value = "到前台天猫-用户详情页")
    ...
    @ApiOperation(value = "到前台天猫-用户详情页 - 返回数据")
    @ResponseBody
    @RequestMapping(value = "userDetails/getdata", method = RequestMethod.GET,produces = "application/json;charset=utf-8")
    public String goToUserDetailGetData(HttpSession session) {
       ...
       /* logger.info("获取用户所在地区级地址");
        ...
        object.put("districtList", districtList);
        object.put("addressId", cityAddress.getAddress_regionId().getAddress_areaId());
        object.put("cityAddressId", cityAddress.getAddress_areaId());
        object.put("districtAddressId", districtAddressId);*/
        return object.toJSONString();
    }
    //前台天猫-用户更换头像
    @ApiOperation(value = "前台天猫-用户更换头像")
    @ResponseBody
    ...
    //前台天猫-用户详情更新
    @ApiOperation(value = "前台天猫-用户详情更新")
