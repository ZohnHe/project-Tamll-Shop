...
import com.qf.tmall.service.ProductOrderService;
...
public class AdminHomeController extends BaseController {
    ...
    @ApiOperation(value = "转到后台管理-主页 - 返回相关数据")
    @ResponseBody
    @RequestMapping(value = "admin/home/getdata", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
    public String goToPageGetData(HttpSession session) throws ParseException {
        logger.info("检查管理员权限");
        Object adminId = checkAdmin(session);
        if (adminId == null) {
            return "admin/include/loginMessage";
        ...
        logger.info("获取图表信息");
        object.put("jsonObject", getChartData(null, null));
        logger.info("获取图表信息");
        object.put("jsonObject", getChartData(null,null));
        object.put("productTotal", productTotal);
        object.put("userTotal", userTotal);
        object.put("orderTotal", orderTotal);
    ...
    //获取图表的JSON数据
    @ApiOperation(value = "获取图表的JSON数据")
    @ResponseBody
    @GetMapping(value = "admin/home/getobjectdata")
