...
public class ProductShowResp {
    ...
    public ProductShowResp(){

    }

    public ProductShowResp(Integer product_id, String product_name, Double product_sale_price, Category product_category, Byte product_isEnabled) {
    ...
    public ProductShowResp setProduct_id(Integer product_id) {
        this.product_id = product_id;
        return this;
    }
    ...
    public ProductShowResp setProduct_name(String product_name) {
        this.product_name = product_name;
        return this;
    }
    ...
    public ProductShowResp setProduct_title(String product_title) {
        this.product_title = product_title;
        return this;
    }
    ...
    public ProductShowResp setProduct_price(Double product_price) {
        this.product_price = product_price;
        return this;
    }
    ...
    public ProductShowResp setProduct_sale_price(Double product_sale_price) {
        this.product_sale_price = product_sale_price;
        return this;
    }
    ...
    public ProductShowResp setProduct_create_date(Date product_create_date) {
        this.product_create_date = product_create_date;
        return this;
    }
    ...
    public ProductShowResp setProduct_category(Category product_category) {
        this.product_category = product_category;
        return this;
    }
    ...
    public ProductShowResp setProduct_isEnabled(Byte product_isEnabled) {
        this.product_isEnabled = product_isEnabled;
        return this;
    }
    ...
    public ProductShowResp setSingleProductImageList(List<ProductImage> singleProductImageList) {
        this.singleProductImageList = singleProductImageList;
        return this;
    }
    ...
    public ProductShowResp setDetailProductImageList(List<ProductImage> detailProductImageList) {
        this.detailProductImageList = detailProductImageList;
        return this;
    }
    ...
    public ProductShowResp setPropertyValueList(List<PropertyValue> propertyValueList) {
        this.propertyValueList = propertyValueList;
        return this;
    }
    ...
    public ProductShowResp setReviewList(List<Review> reviewList) {
        this.reviewList = reviewList;
        return this;
    }
    ...
    public ProductShowResp setProductOrderItemList(List<ProductOrderItem> productOrderItemList) {
        this.productOrderItemList = productOrderItemList;
        return this;
    }
    ...
    public ProductShowResp setProduct_sale_count(Integer product_sale_count) {
        this.product_sale_count = product_sale_count;
        return this;
    }
    ...
    public ProductShowResp setProduct_review_count(Integer product_review_count) {
        this.product_review_count = product_review_count;
        return this;
    }
}
